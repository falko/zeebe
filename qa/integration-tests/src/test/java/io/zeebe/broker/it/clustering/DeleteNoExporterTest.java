...
public class DeleteNoExporterTest extends DeletionTest {
  public static final int SNAPSHOT_PERIOD_SECONDS = 30;
  public static final int MAX_SNAPSHOTS = 1;

  public ClusteringRule clusteringRule = new ClusteringRule(1, 3, 3, this::configureNoExporters);
  ...
  private void configureNoExporters(final BrokerCfg brokerCfg) {
  ...
  public void shouldDeleteDataOnFollowers() {
    shouldDeleteDataOnFollowers(clusteringRule, clientRule);
  }

  @Test
  public void shouldDeleteDataOnLeader() {
    shouldDeleteDataOnLeader(clusteringRule, clientRule);
  }
}
